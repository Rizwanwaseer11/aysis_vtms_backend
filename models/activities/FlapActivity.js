 ...
 * Flap Activity:
 * - Supervisor + Driver
 * - Supervisor logs MT arrival by MT number
 * - Before/After images for MT unloading event
 * - mtVisitCount increments if same MT serves again (handled in controller)
 */
...
Schema.index({ "flap.mtNumber": 1, createdAt: -1 });

module.exports = mongoose.model("FlapActivity", Schema);
