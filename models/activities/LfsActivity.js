...
/**
 * LFS Activity (Landfill / recycle transfer):
 * - Same gts point selection, but purpose is transfer to recycle company
 */
...
Schema.index({ "lfs.gtsPointId": 1, createdAt: -1 });

module.exports = mongoose.model("LfsActivity", Schema);
