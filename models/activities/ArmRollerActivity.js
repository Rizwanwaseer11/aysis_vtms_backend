 ...
 * ARM Roller Activity:
 * - Only driver
 * - Works with 5 cubic bin numbers (no geo location stored for bin itself)
 * - Records swapping / emptying
 */
...
deletedAt: { type: Date, default: null },
    arm: {
      binId: { type: mongoose.Schema.Types.ObjectId, ref: "Bin5", default: null },
...
Schema.index({ "arm.binNumber": 1, createdAt: -1 });

module.exports = mongoose.model("ArmRollerActivity", Schema);
